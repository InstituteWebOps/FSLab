        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="about-us text-center">
                    <h4>We are a group of....</h4>
                    <p>Some text here
                        <hr> text text text text text text text text text text text text text text text text text text text text
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="fun-fact text-center">
                        <h3>
                            ...
                            <span class="st-counter">168</span>
                        </h3>
                        <p>Publishings in International Journals</p>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="fun-fact text-center">
